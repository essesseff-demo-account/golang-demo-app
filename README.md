# golang-demo-app Application (Go)
...
* Source: [golang-demo-app (this repo)](https://github.com/essesseff-demo-account/golang-demo-app)
* Helm Config DEV: [golang-demo-app-config-dev](https://github.com/essesseff-demo-account/golang-demo-app-config-dev)
* Helm Config QA: [golang-demo-app-config-qa](https://github.com/essesseff-demo-account/golang-demo-app-config-qa)
* Helm Config STAGING: [golang-demo-app-config-staging](https://github.com/essesseff-demo-account/golang-demo-app-config-staging)
* Helm Config PROD: [golang-demo-app-config-prod](https://github.com/essesseff-demo-account/golang-demo-app-config-prod)
* Argo CD Config DEV: [golang-demo-app-argocd-dev](https://github.com/essesseff-demo-account/golang-demo-app-argocd-dev)
* Argo CD Config QA: [golang-demo-app-argocd-qa](https://github.com/essesseff-demo-account/golang-demo-app-argocd-qa)
* Argo CD Config STAGING: [golang-demo-app-argocd-staging](https://github.com/essesseff-demo-account/golang-demo-app-argocd-staging)
* Argo CD Config PROD: [golang-demo-app-argocd-prod](https://github.com/essesseff-demo-account/golang-demo-app-argocd-prod)
...
* **K8s Namespace**: unless otherwise specified, this template assumes, by default, a mapping of GitHub organization ~ K8s namespace i.e. string replace essesseff-demo-account with your K8s namespace (or use the [essesseff onboarding utility](https://github.com/essesseff/essesseff-onboarding-utility) to perform string replacement automatically)
...
# Build container
docker build -t golang-demo-app:local .
docker run -p 8080:8080 golang-demo-app:local
```
